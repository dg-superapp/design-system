...
- [x] 04-09-PLAN.md — Wave 6 finalize — bump `registry.json` to 0.4.0 with 8 new items, full smoke-consumer walk over 22 entries, visual-diff sweep, ROADMAP exit-gate edit (D-02).

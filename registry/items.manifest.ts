...
export const items: ManifestEntry[] = [
  ...
  // === Phase 4 — Headers + Navigation (8 entries, hoisted per ISSUE-01 atomic finalize) ===
  {
    ...
    title: 'AppHeader',
    docsSlug: 'app-header',
    registryUrl: itemUrl('app-header'),
    ...
    controls: [
      {
        ...
        name: 'title',
        label: 'Title',
        default: 'ដាក់ពាក្យទិដ្ឋាការ',
        placeholder: 'Apply for visa',
      },
      {
        kind: 'variant',
        name: 'leadingIcon',
        label: 'Leading icon',
        options: ['menu', 'back', 'none'] as const,
        default: 'menu',
      },
  ...
  },
  {
    ...
    registryUrl: itemUrl('section-header'),
    ...
    controls: [
      {
        ...
        name: 'trailing',
        label: 'Trailing',
        options: ['chevron', 'count', 'switch', 'none'] as const,
        default: 'chevron',
      },
  ...
  },
  {
    ...
    registryUrl: itemUrl('segmented-tabs'),
  ...
  },
  {
    ...
    registryUrl: itemUrl('step-indicator'),
    ...
    controls: [
      ...
      },
      {
        kind: 'number',
        name: 'activeIndex',
        label: 'Active step index (0-based)',
        default: 1,
        min: 0,
        max: 4,
      },
  ...
  },
  {
    ...
    registryUrl: itemUrl('hero-banner'),
  ...
  },
  {
    ...
    registryUrl: itemUrl('side-drawer'),
  ...
  },
  {
    ...
    registryUrl: itemUrl('miniapp-home'),
    description:
      'Composed MiniApp home — AppHeader + HeroBanner + SectionHeader + NavRow + tile grid. Phase 4 exit-gate composition.',
    controls: [] as const,
  },
];
